...
class DefaultButton(PushButton):
    def __init__(self, __text: str, width: int = 200, height: int = 25):
        ...
        self.setStyleSheet(FileLoader.load_style("scr/interface/basic/styles/default_button.css"))


class HighlightedButton(PushButton):
    def __init__(self, __text: str, color: str, border_color: str, width: int = 200, height: int = 25) -> None:
        super().__init__(__text, width, height)
...
class DialogButton(PushButton):
    def __init__(self, __text: str, button_type: str = "accept", width: int = 200, height: int = 25) -> None:
        super().__init__(__text, width, height)
